...
const Perfil = () => {
  ...
  //     const response = await api.get(`/api/checkFollowing?following_user_id=${currentUser.id}&followed_user_id=${userId}`);
  ...
  const handleUnfollow = async () => {
    try {
      ...
      const response = await api.delete(`/api/unfollow?following_user_id=${currentUser.id}&followed_user_id=${userId}`);
